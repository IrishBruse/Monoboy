...
namespace Monoboy.Utility
{
    class TinyFileDialog
    {
        ...
        {
            return StringFromAnsi(tinyfd_saveFileDialog(title, defaultPathAndFile, numOfFilterPatterns, filterPatterns, singleFilterDescription));
        }
        ...
        {
            return StringFromAnsi(tinyfd_openFileDialog(title, defaultPathAndFile, numOfFilterPatterns, filterPatterns, singleFilterDescription, allowMultipleSelects));
        }
