...
namespace Monoboy
{
    public class Memory
    {
        ...
        public byte JOYP { get => io[0x0000]; set => io[0x0000] = value; }
        public byte LCDC { get => io[0x0040]; set => io[0x0040] = value; }
        public byte Stat { get => io[0x0041]; set => io[0x0041] = value; }
        public byte StatMode { get => io[0x0041].GetBits(0b00000011); set => io[0x0041] = io[0x0041].SetBits(0b00000011, value); }
